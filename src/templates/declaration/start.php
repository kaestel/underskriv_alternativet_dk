	...
	<form name="declaration" action="/vaelgererklaering/signature" method="post">
		<fieldset>
			...
			<div class="field postalcity required">
				...
				<input type="number" pattern="[0-9]*" name="postal" class="postal" id="postal" value="<?= $postal ?>" />
			...
			<div class="field cpr required">
				...
				<input type="number" pattern="[0-9]*" name="cpr_1" value="<?= $cpr_1 ?>" id="cpr" class="cpr1" /><span>-</span><input type="number" pattern="[0-9]*" name="cpr_2" value="<?= $cpr_2 ?>" class="cpr2" />
			</div>
