...
<head>
	...
	<style type="text/css">
		...
		div#page {width: 900px; padding: 675px 0 0; background: transparent url(/img/<?= $slug ?>/bg_standardvaelgererklaering_2390.png) no-repeat left 170px; background-size: 100% auto;}
